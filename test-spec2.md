...
#### 3.1.6. Identifier: TEST_4b {#test-4b}
...
#### 3.2.1. Identifier: TEST_5a {#test-5a}
...
|      |          |                                                          |
|      |          | - Object-Security option                                 |
|      |          | - Location-path = /hello/5                               |
|      |          | - Location-Query : first=1                               |
+------+----------+----------------------------------------------------------+
| 5    | Verify   | Client displays the received packet                      |
+------+----------+----------------------------------------------------------+

#### 3.2.2. Identifier: TEST_5b {#test-5b}
...
#### 3.3.1. Identifier: TEST_6a {#test-6a}
...
#### 3.3.2. Identifier: TEST_6b {#test-6b}
...
#### 3.3.3. Identifier: TEST_7a {#test-7a}
...
#### 3.3.4. Identifier: TEST_7b {#test-7b}
...
#### 3.4.1. Identifier: TEST_8a {#test-8a}
...
#### 3.4.2. Identifier: TEST_8b {#test-8b}
